...
```json
{
  "apiDescription" : "Instantiates everything",
  "apiOwner" : "Dan",
  "apiSystem" : "Genesis",
  ...
  "sourceRepositoryPrefix" : "ed7149eb94c74c2ab15c3d467f095a87.azurecr.io/tap-grey/src"
}
```
## Log
```
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃  Info Condition (#exposeOpenAPIEndpoint) evaluated to true
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┗  Info Will replace [DESCRIPTION_VAL->Instantiates everyth...(truncated), OWNER_VAL->Dan, SYSTEM_VAL->Genesis]
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┗ ┗  Info Will replace [dev.local->ed7149eb94c74c2ab15c...(truncated)]
